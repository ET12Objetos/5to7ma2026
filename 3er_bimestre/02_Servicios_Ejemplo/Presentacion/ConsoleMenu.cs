...
internal sealed class ConsoleMenu
{
    ...
    public ConsoleMenu(IUsuarioRepositorio usuarioRepositorio,
    ...
    private void RegistrarUsuario()
    {
        ...
        var id = _usuarioRepositorio.Crear(usuario);
    ...
    private void CambiarRolUsuario()
    {
        ...
        var actualizado = _usuarioRepositorio.ActualizarRol(usuarioId, rolId);
    ...
    private void CambiarEstadoUsuario()
    {
        ...
        var actualizado = _usuarioRepositorio.CambiarEstado(usuarioId, activo);
