...
var menu = new ConsoleMenu(
    new ClienteServicio(clienteRepositorio),
    new ProfesionalServicio(profesionalRepositorio),
    new ServicioServicio(servicioRepositorio),
    new TurnoServicio(turnoRepositorio, clienteRepositorio, profesionalRepositorio, servicioRepositorio));
