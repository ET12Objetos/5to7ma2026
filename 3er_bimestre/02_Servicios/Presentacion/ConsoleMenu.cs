...
{
    private readonly ClienteServicio _clienteServicio = clienteServicio ?? throw new ArgumentNullException(nameof(clienteServicio));
    private readonly ProfesionalServicio _profesionalServicio = profesionalServicio ?? throw new ArgumentNullException(nameof(profesionalServicio));
    private readonly ServicioServicio _servicioServicio = servicioServicio ?? throw new ArgumentNullException(nameof(servicioServicio));
    private readonly TurnoServicio _turnoServicio = turnoServicio ?? throw new ArgumentNullException(nameof(turnoServicio));
    ...
    private void SolicitarTurno()
    {
        ...
        var id = _turnoServicio.Solicitar(turno);
